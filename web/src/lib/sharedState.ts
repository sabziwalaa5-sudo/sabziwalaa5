...
// Initial Categories with High-Quality Unsplash Images
...
// Initial products — with Unsplash high-resolution photography & badges
export const INITIAL_PRODUCTS = [
  {
    id: "p1",
    name: "Pahadi Organic Potatoes",
    hindiName: "जैविक पहाड़ी आलू",
    price: 40,
    oldPrice: 55,
    unit: "1 kg",
    image: "🥔",
  ...
  },
  {
    ...
    unit: "500 g",
    image: "🍅",
    imageUrl: "https://images.unsplash.com/photo-1546470427-e26264be0b0c?w=500&q=80",
    category: "Vegetables",
    stock: 80,
    rating: 4.7,
    reviewsCount: 98,
  ...
  {
    id: "p7",
    name: "Fresh A2 Farm Milk",
    hindiName: "शुद्ध A2 गाय का दूध",
    price: 75,
    oldPrice: 85,
    unit: "1 Litre",
    image: "🥛",
...
export const INITIAL_REVIEWS = [
  {
    ...
    rating: 5,
    comment: "The organic Pahadi potatoes & Alphonso mangoes delivered from Rajokri Hub were amazingly fresh! Loved the rapid hyperlocal delivery.",
  ...
  },
  {
    ...
    location: "Rajokri Crossroad",
    rating: 5,
    comment: "Super impressed by the quality of A2 milk and organic spinach. Zero pesticides taste real!",
  ...
  },
  {
    ...
    rating: 5,
    comment: "The UI is so sleek, fast and modern! Loved using points for instant cashback discounts.",
...
export const INITIAL_WALLETS = {
  ...
  "rahul@gmail.com": {
    ...
    lifetimeRedeemed: 0,
    history: [
      { id: "tx_l1", type: "EARNED", points: 40, orderId: "SBJ50001", date: "2026-06-25 10:15 AM", balance: 40 }
    ]
  }
};
...
// Safe localStorage helpers for Next.js SSR
